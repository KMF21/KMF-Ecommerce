          ...
          <ClerkLoaded>
            ...
            {user ? (
              <div className="flex items-center space-x-2">
                ...
                <div className="hidden sm:block text-xs">
                  ...
                  <p className="font-bold className">{user.fullName}!</p>
                </div>
              </div>
            ) : (
            ...
            {user?.passkeys.length === 0 && (
              <button
                ...
                className="bg-white hover:bg-blue-700 hover:text-white abimate-pulse text-blue-500 font-bold py-2 px-4 rounded border-blue-300 border"
              >
